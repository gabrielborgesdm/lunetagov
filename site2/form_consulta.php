<form name="consulta" action="consultas.php" method="post">
	...
	<input type="checkbox" name="listarFuncao"> Função  
	<input type="checkbox" name="listarSubFuncao">SubFunção  
	<input type="checkbox" name="listarAcao"> Ação  
	<input type="checkbox" name="listarOrgao"> Orgão 
	<input type="checkbox" name="listarCategoria"> Categoria 
	<input type="checkbox" name="listarGrupo"> Grupo 
	<input type="checkbox" name="listarUnidadeOrcamentaria"> Unidade Orçamentária <br><br>
	<input type="checkbox" name="listarUnidadeGestora"> Unidade Gestora 
	<input type="checkbox" name="listarModalidade"> Modalidade 
	<input type="checkbox" name="listarElemento"> Elemento 
	<input type="checkbox" name="listarItem"> Item 
	<input type="checkbox" name="listarCredor"> Credor 
	<input type="checkbox" name="listarLicitacao"> Licitação 
	<input type="checkbox" name="listarFonteRecursos"> Fonte de Recursos
	...
	<input type="checkbox" name="listarValorPago"> Valor Pago 	
	<input type="checkbox" name="listarValorEmpenhado"> Valor Empenhado 
	<input type="checkbox" name="listarValorLiquido"> Valor Liquidado 
	<input type="checkbox" name="listarDeAnosAnteriores"> Valor de Anos Anteriores 
	</fieldset>
<br>
	<!--
<fieldset>
