<?php
	session_start();
        ...
        if(!isset($_SESSION["ano"])){
            echo"<p>Carregamento de 2016 Iniciado</p>";
            $ano = 2016;
            $arquivo = "despesa2016.csv";
            $_SESSION["ano"] = 2017;
        }
        else{
            echo"<p>Carregamento de 2016 concluido</p>";
            echo"<p>Carregamento de 2017 iniciado</p>";
            $ano = 2017;
            $arquivo = "despesa2017.csv";
            $_SESSION["parar"] = true;
...
<html>
	<body>
		...
		<?php
		if(isset($_SESSION["parar"])){
                    echo"<p>Carregamento de 2017 Iniciado</p>";
                    session_destroy();
                }
                else{
                    header("Location:carregador_despesa_estado.php");
                }
                ?>
        }
